...
function write_player_position()
  ...
  local room_bounds_x = emu.readWord(emu.getLabelAddress("room_bounds_x")["address"], emu.memType.nesDebug)
  local room_bounds_y = emu.readWord(emu.getLabelAddress("room_bounds_y")["address"], emu.memType.nesDebug)
  local view_y = emu.read( emu.getLabelAddress("view_y")["address"], emu.memType.nesDebug)
